...
exports.calculateBestTeams = function (cachedJsonData, selectedChip) {
    ...
    const teamBudget = calculateTeamBudget(current_team, drivers_dict, constructors_dict);
...
exports.calculateChangesToTeam = function (cachedJsonData, targetTeam, selectedChip) {
    ...
    if (selectedChip === WILDCARD_CHIP) {
        ...
        const currentTeamBudget = calculateTeamBudget(currentTeam, cachedJsonData.Drivers, cachedJsonData.Constructors);
