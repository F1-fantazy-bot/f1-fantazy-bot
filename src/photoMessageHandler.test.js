        ...
        expect(bot.sendMessage).toHaveBeenCalledWith(
            ...
            expect.objectContaining({
                ...
                reply_markup: {
                    inline_keyboard: [
                        [
                            { text: 'Drivers', callback_data: `${DRIVERS_PHOTO_TYPE}:unique2` },
                            { text: 'Constructors', callback_data: `${CONSTRUCTORS_PHOTO_TYPE}:unique2` },
                            { text: 'Current Team', callback_data: `${CURRENT_TEAM_PHOTO_TYPE}:unique2` },
                        ]
                    ]
                }
            })
